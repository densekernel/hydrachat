<?php
	...
	$error_destination = "unwhisper.txt";
	...
	$sql = "UPDATE " . $confname . " SET WhisperingTo = 'null' WHERE UserName = '" . $username . "'";
	$sql2 = "UPDATE " . $confname . " SET WhisperingTo = 'null' WHERE UserName = '" . $whisperingto . "'";

	if(mysqli_query($con, $sql)){
		logError("Whisper removed: " . $username . $whisperingto, $error_destination);
		mysqli_query($con, $sql2);
	}else{
		logError("Whisper remove failed " . $username, $error_destination);
	}
